...
int main()
{
  ...
  for (int j=0; j<1000000; j++)
	...
	crcTemp[i] = crc[i];
      ...
      flipN[3] = randTo0to223(rnd.Rndm(), div);
      flipN[4] = randTo0to223(rnd.Rndm(), div);
      flipN[5] = randTo0to223(rnd.Rndm(), div);
	...
	flipN[4] = randTo0to223(rnd.Rndm(), div);
      ...
      while (flipN[5] == flipN[0] || flipN[5] == flipN[1] || flipN[5] == flipN[2] || flipN[5] == flipN[3] || flipN[5] == flipN[4])
	flipN[5] = randTo0to223(rnd.Rndm(), div);
